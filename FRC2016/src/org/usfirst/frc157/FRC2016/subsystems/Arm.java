...
public class Arm extends PIDSubsystem {
    ...
    private final Encoder shoulderEncoder = RobotMap.armShoulderEncoder;
    ...
    public boolean home()
    {
    	// TODO Write the HOME function for the arm
    	// move mid speed to find change in mid position sensor
    	
    	// carefully find the edge
    	
    	// Once the edge is found - reset or note the encoder positions so we can find angles
    	return false;
    }
}
