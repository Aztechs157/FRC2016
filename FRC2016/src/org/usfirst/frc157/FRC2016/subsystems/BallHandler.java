...
//    private final AnalogInput ballRangefinder = RobotMap.ballHandlerBallRangefinder;
    ...
    private DigitalInput ballInHolderSwitch;
    ...
    public BallHandler()
    {
    	...
    	if(ballInHolderSwitch == null)
    	{
        	ballInHolderSwitch = new DigitalInput(RobotMap.BallInHolderSwitchDigitialInID);
    	}
    }
...
//    	return (inHolder || ((RANGE_MIN_IN_HOLDER <= range) && (range <= RANGE_MAX_IN_HOLDER)));
    }
