...
public class OI {
    ...
    public OI() {
        ...
        logitechDriver = new LogitechController(OI.PIT_CONTROLLER_ID);
        ...
        driverLeftButtonTrigger.whenPressed(new PrintButton("L Button T"));
        driverLeftButton2.whenPressed(new PrintButton("L Button 2"));
        driverLeftButton3.whenPressed(new PrintButton("L Button 3"));
        driverLeftButton4.whenPressed(new PrintButton("L Button 4"));
        driverLeftButton5.whenPressed(new PrintButton("L Button 5"));
        ...
        driverRightButton3.whenPressed(new PrintButton("R Button 3"));
        driverRightButton4.whenPressed(new PrintButton("R Button 4"));
        driverRightButton5.whenPressed(new PrintButton("R Button 5"));
