...
public class OI {
    ...
    public static final int LOGITECH_CONTROLLER_ID = 3;
        
    public static final boolean USE_OPERATOR_JOYSTICK = false;  //true = Joystick operator; false = Logitech operator  
  ...
  //  private JoystickButton operatorButton12; // Button 12
    ...
    public OI() {
        ...
        if (USE_OPERATOR_JOYSTICK)
        {
            operator = new Joystick(OPERATOR_JOYSTICK_ID);
        }
        else // USE_OPERATOR_JOYSTICK
        {
...
//        driverLeftButton12.whenPressed(new PrintButton("L Button 12"));
        ...
        driverRightButton8.whenPressed(new ArmExtendRetract(true));
        driverRightButton9.whenPressed(new ArmExtendRetract(false));
    ...
    //        operatorButton12.whenPressed(new TurnToHeading(-90));
        ...
        else // USE_OPERATOR_JOYSTICK
        {
          ...
          //  logitechDriverButtonLeftStick.whenHeld(new ArmShoulderManual(ArmShoulderManual.Direction.UP));
            ...
            logitechDriverButtonGameUp.whenPressed(new ArmExtendRetract(true));
            logitechDriverButtonGameDown.whenPressed(new ArmExtendRetract(false));
            logitechDriverButtonGameLeft.whenPressed(new ArmShoulderManual(ArmShoulderManual.Direction.UP));
